    ...
    sections: [
      ...
      },
      {
        ...
        bullets: [
          ...
          'Descer de plano ou voltar ao Free não apaga nada: o que exceder o novo plano deixa de aparecer na página e fica guardado; volta se você voltar. Com mês pago em aberto, a mudança é agendada para o fim dele. O endereço público do perfil nunca muda por causa de plano.',
