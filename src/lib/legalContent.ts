...
export const LEGAL_DOCS: LegalDocContent[] = [
  {
    ...
    sections: [
      ...
      },
      {
        ...
        bullets: [
          'Sua conta: e-mail, data de criação e a senha, se você criou uma — guardada apenas como hash (scrypt, com sal aleatório), do qual ela não pode ser recuperada. Se você entra com o Google, guardamos também o identificador que o Google dá à sua conta (um número; nunca a senha do Google). Guardamos ainda as sessões abertas (quando começaram e até quando valem), sem endereço IP na própria sessão.',
