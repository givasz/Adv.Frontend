      ...
      <main className="mx-auto flex w-full max-w-5xl flex-1 items-center px-5 py-6">
        <div className="grid w-full items-center gap-12 lg:grid-cols-[1fr_minmax(0,26rem)]">
          ...
          >
            ...
            {/* O mesmo botão nos dois modos: quem ainda não tem conta e toca nele
                em "Entrar" recebe o aceite dos Termos na volta do Google, e quem
                já tem e toca em "Criar conta" simplesmente entra. O "continuar
                conectado" vale para ele também — vai junto na ida. */}
            <BotaoGoogle next={next} lembrar={remember} />
